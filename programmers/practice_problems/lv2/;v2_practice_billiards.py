...
def solution(m, n, startX, startY, balls):
    ...
    for ball in balls:
        left = (startX + ball[0])**2 + (startY - ball[1])**2
        right = (2*m - startX - ball[0])**2 + (startY - ball[1])**2
        up = (startX - ball[0])**2 + (2*n - startY - ball[1])**2
        down = (startX - ball[0])**2 + (startY + ball[1])**2
        
        if startX > ball[0] and startY == ball[1]:
            left = INFINITE
        if startX < ball[0] and startY == ball[1]:
            right = INFINITE
        if startY > ball[1] and startX == ball[0]:
            down = INFINITE
        if startY < ball[1] and startX == ball[0]:
            up = INFINITE
